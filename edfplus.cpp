...
class Cedfplus
{
	...
	struct edf_file_S
	{
		format_S            format;                        ///< ascii : version of this data format (0) 
        localPatientID_S    localPatientID;                ///< ascii : local patient identification (mind item 3 of the additional EDF+ specs)
		localRecordingID_S  localRecordingID;        ///< ascii : local recording identification (mind item 4 of the additional EDF+ specs)
		startDate_S			startDate;                        ///< ascii : startdate of recording (dd.mm.yy) (mind item 2 of the additional EDF+ specs)
		startTime_S			startTime;;                        ///<  ascii : starttime of recording (hh.mm.ss) 
	};
/*
8 ascii : number of bytes in header record 
44 ascii : reserved 
