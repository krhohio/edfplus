...
/*! \class Test
	...
	HEADER RECORD \todo (we suggest to also adopt the 12 simple additional EDF+ specs)
	8 ascii : version of this data format (0) 
	80 ascii : local patient identification \todo (mind item 3 of the additional EDF+ specs)
	80 ascii : local recording identification \todo (mind item 4 of the additional EDF+ specs)
	8 ascii : startdate of recording (dd.mm.yy) \todo (mind item 2 of the additional EDF+ specs)
	8 ascii : starttime of recording (hh.mm.ss) 
	8 ascii : number of bytes in header record 
	44 ascii : reserved 
	8 ascii : number of data records \todo (-1 if unknown, obey item 10 of the additional EDF+ specs) 
	8 ascii : duration of a data record, in seconds 
	4 ascii : number of signals (ns) in data record 
	ns * 16 ascii : ns * label (e.g. EEG Fpz-Cz or Body temp) \todo (mind item 9 of the additional EDF+ specs)
